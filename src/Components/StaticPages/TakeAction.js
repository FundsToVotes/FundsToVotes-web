...
function OurData() {
    return (
        <div style={{ display: "block", margin: "auto", width: '75%', paddingTop: '20px', backgroundColor: 'white', padding: '30px', marginTop: '30px' }}>
            ...
            <p>Did you learn something about your members of Congress' voting records or campaign funding that you'd like to comment on? Do you want them to support H.R. 1? Use the phone number or website listed on the details page to call or send a message to your reperesentative or senator.</p>

            {/* <h3>Learn About Other Organizations</h3> */}
        </div>
    );
}
